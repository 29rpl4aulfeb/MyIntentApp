    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_move_activity_object:
                Person manusia = new Person("Justyeah","aulia_febianca_29rpl@student.smktelkom-mlg.sch.id","New York", 17);
            ...
            case R.id.btn_dial_number:
                String phoneNumber = "082131194678";
                //Uri adalah data yang dikirim ke intent aplikasi yaitu dial
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data){
        ...
        if(requestCode==REQUEST_CODE){
            if(resultCode==MoveForResultActivity.RESULT_CODE){
                int selectValue = data.getIntExtra(MoveForResultActivity.EXTRA_SELECTED_VALUE, 0);
